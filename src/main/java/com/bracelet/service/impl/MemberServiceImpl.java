...
public class MemberServiceImpl implements IMemService {
	...
	public boolean insert(Long user_id, String tel, String name,String imei) {
		...
		int i = jdbcTemplate.update(
				"insert into member_info (user_id, imei, phone, name,createtime, updatetime) values (?,?,?,?,?,?)",
				new Object[] { user_id,imei,tel,name, now, now },
				new int[] { Types.INTEGER, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.TIMESTAMP, Types.TIMESTAMP });
		return i == 1;
	}
	...
	public List<MemberInfo> getMemberInfo(Long user_id, String imei) {
		...
		List<MemberInfo> list = jdbcTemplate.query(sql, new Object[] { user_id,imei },
	...
	public boolean delete(Long user_id, Long id) {
		int i = jdbcTemplate.update("delete from member_info where id = ? and user_id = ?", new Object[] { id, user_id },
	...
	public MemberInfo getMemberInfobyTel(Long user_id, String imei, String tel) {
		...
		List<MemberInfo> list = jdbcTemplate.query(sql, new Object[] { user_id,imei,tel },
				new BeanPropertyRowMapper<MemberInfo>(MemberInfo.class));
	...
	public boolean deleteAll(Long user_id) {
		 jdbcTemplate.update("delete from member_info where   user_id = ?", new Object[] { user_id },
	...
	public boolean deleteByImei(String imei) {
		 jdbcTemplate.update("delete from member_info where   imei = ?", new Object[] { imei },
