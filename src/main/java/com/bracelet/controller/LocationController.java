...
public class LocationController extends BaseController {
	...
	@ResponseBody
	@RequestMapping(value = "/ask/location/{token}/{imei}", method = RequestMethod.GET)
	public HttpBaseDto askLocation(@PathVariable String token,@PathVariable String imei) {
		Long user_id = checkTokenAndUser(token);
